...
from ..models import MinionCard, ActionCard, ScrapingResult
...
class CardScraper(BaseScraper):
    ...
    def scrape_faction_cards(self, faction_name: str, faction_id: str) -> ScrapingResult:
        """
        ...
        try:
            ...
            if cards:
                ...
                return self._create_error_result(
                    f"No cards found for faction {faction_name}",
                    errors
                )
    ...
    def _parse_card_from_text(
        ...
        try:
            ...
            if is_minion_card_text(text):
                return self._parse_minion_card(text, card_name, faction_name, faction_id)
            else:
                return self._parse_action_card(text, card_name, faction_name, faction_id)
