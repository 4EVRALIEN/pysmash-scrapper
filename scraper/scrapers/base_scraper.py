...
class BaseScraper(ABC):
    ...
    def _create_success_result(self, message: str, items_processed: int = 0) -> ScrapingResult:
        """
    ...
    def _create_error_result(self, message: str, errors: List[str] = None) -> ScrapingResult:
        """
